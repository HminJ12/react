...
const CompLi = ({i}) => {
  const {_pointArr, _setPointArr, fnChangePoint, _setReadOnly, _readOnly, _setShowBtn, _setStyle,_style, _listCnt} = useContext(AppContext)
  ...
  function fnInputHandler(e){
    ...
    _setStyle((fnChangePoint(pointArr) === _listCnt)? '#CCC':'#FFF')
